...
function LandingPage() {
  ...
  */}
            <section className="bg-white py-8 font-fredoka">
                <div className="container mx-auto flex items-center flex-wrap pt-4 pb-12">
                    <nav id="store" className="w-full  top-0 px-6 py-1">
                        <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-2 py-3">
                            <span className="italic tracking-wide no-underline hover:no-underline font-bold text-gray-800 md:text-xl text-md ">
                                India's First Leading Freshly Milled flours,
                                Spices , Oiles & kitchen Essentials Delivery
                                Platform
                            </span>
                            <div
